...
final List<Country> countries = [
  Country(code: '+93', name: 'Afghanistan'),
Country(code: '+355', name: 'Albania'),
Country(code: '+213', name: 'Algeria',),
Country(code : '+1684', name: 'American Samoa',),
Country(code: '+376', name: 'Andorra',),
Country(code: '+244', name: 'Angola', ),
Country(code: '+1264', name: 'Anguilla', ),
Country(code: '+672', name: 'Antarctica',),
Country(code: '+1268', name: 'Antigua and Barbuda', ),
Country(code: '+54', name: 'Argentina', ),
Country(code: '+374', name: 'Armenia', ),
 // {'code': '+297', 'name': 'Aruba', 'flag': '🇦🇼'},
  Country(code: '+61', name: 'Australia', ),
  Country(code: '+43', name: 'Austria', ),
 // {'code': '+994', 'name': 'Azerbaijan', 'flag': '🇦🇿'},
//  {'code': '+1242', 'name': 'Bahamas', 'flag': '🇧🇸'},
 Country(code: '+973', name: 'Bahrain', ),
Country(code: '+880', name: 'Bangladesh', ),
...
Country(code: '+358', name: 'Finland', ),
Country(code: '+33', name: 'France', ),
...
Country(code: '+354', name: 'Iceland',),
Country(code: '+91', name: 'India', ),
Country(code: '+62', name: 'Indonesia', ),
Country(code: '+98', name: 'Iran', ),
Country(code: '+964', name: 'Iraq',),
Country(code: '+353', name: 'Ireland', ),
 // {'code': '+44-1624', 'name': 'Isle of Man', 'flag': '🇮🇲'},
Country(code: '+972', name: 'Israel', ),
Country(code: '+39', name: 'Italy', ),
  //{'code': '+225', 'name': 'Ivory Coast', 'flag': '🇨🇮'},
 // {'code': '+1876', 'name': 'Jamaica', 'flag': '🇯🇲'},
Country(code: '+81', name: 'Japan', ),
  ...
  Country(code: '+84', name: 'Vietnam', ),
Country(code: '+1284',  name: 'British Virgin Islands',),
Country(code: '+1340',  name: 'U.S. Virgin Islands', ),
Country(code: '+681',  name: 'Wallis and Futuna', ),
Country(code: '+967',  name: 'Yemen', ),
Country(code: '+260',  name: 'Zambia',),
Country(code: '+263',  name: 'Zimbabwe', ),
];
