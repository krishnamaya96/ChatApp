...
ThemeData lightThemeData(BuildContext context) {
  return ThemeData(
    ...
    visualDensity: VisualDensity.adaptivePlatformDensity, colorScheme: ColorScheme.light(primary: kPrimaryColor, secondary: kPrimaryColor).copyWith(background: const Color(0xFFFFFFFF)).copyWith(error: kErrorColor),
  );
}
...
ThemeData darkThemeData(BuildContext context) {
  return ThemeData(
    ...
    textTheme: getTextTheme(),
    primaryTextTheme: getTextTheme(),
    visualDensity: VisualDensity.adaptivePlatformDensity, colorScheme: ColorScheme.dark().copyWith(background: Colors.black).copyWith(error: kErrorColor),
  );
}
